...
export class NoteRefactorSettingsTab extends PluginSettingTab {
  ...
  plugin: NoteRefactor
  titleReplacementRulesContainer: HTMLElement
  ...
  display(): void {
    ...
    new Setting(containerEl)
      ...
      .addToggle(toggle =>
        toggle.setValue(this.plugin.settings.transcludeByDefault).onChange(value => {
    ...
    new Setting(containerEl)
      ...
      .addToggle(toggle =>
        toggle.setValue(this.plugin.settings.excludeFirstLineInNote).onChange(value => {
    ...
    new Setting(containerEl)
      ...
      .addToggle(toggle =>
        toggle.setValue(this.plugin.settings.includeFirstLineAsNoteHeading).onChange(value => {
    ...
    new Setting(containerEl)
      ...
      .addToggle(toggle =>
        toggle.setValue(this.plugin.settings.openNewNote).onChange(value => {
    ...
    new Setting(containerEl)
      ...
      .addToggle(toggle =>
        toggle.setValue(this.plugin.settings.normalizeHeaderLevels).onChange(value => {
  ...
  private addTitleReplacementRules(containerEl: HTMLElement): void {
    new Setting(containerEl)
